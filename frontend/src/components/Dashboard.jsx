                                              ...
                                              >
                                                  ...
                                                  <button 
                                                      onClick={async (e) => {
                                                          ...
                                                          try { await fetch(`${API_BASE}/api/bookings/${trip.pnr}`, { method: 'DELETE', headers: { 'x-user-id': user?.id } }); } catch(err){}
                                                      }}
                        ...
                        <div key={idx} className="bg-white dark:bg-slate-800/80 p-6 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-700/80 flex flex-col gap-4 relative group">
                          ...
                          <button 
                            onClick={async (e) => {
                                ...
                                try { await fetch(`${API_BASE}/api/bookings/${booking.pnr}`, { method: 'DELETE', headers: { 'x-user-id': user?.id } }); } catch(err){}
                            }}
...
export { CheckoutPage, HotelCheckoutPage }; 
